...
postgresql_host_name = "127.0.0.1"
...
if __name__ == "__main__":
    ...
    spark = SparkSession \
        ...
        .master("local[*]") \
        .config("spark.jars", "file:////opt//workarea//spark_jars//commons-pool2-2.8.1.jar,file:////opt//workarea//spark_jars//postgresql-42.2.16.jar,file:////opt//workarea//spark_jars//spark-sql-kafka-0-10_2.12-3.0.1.jar,file:////opt//workarea//spark_jars//kafka-clients-2.6.0.jar,file:////opt//workarea//spark_jars//spark-streaming-kafka-0-10-assembly_2.12-3.0.1.jar") \
        .config("spark.executor.extraClassPath", "file:////opt//workarea//spark_jars//commons-pool2-2.8.1.jar:file:////opt//workarea//spark_jars//postgresql-42.2.16.jar:file:////opt//workarea//spark_jars//spark-sql-kafka-0-10_2.12-3.0.1.jar:file:////opt//workarea//spark_jars//kafka-clients-2.6.0.jar:file:////opt//workarea//spark_jars//spark-streaming-kafka-0-10-assembly_2.12-3.0.1.jar") \
        .config("spark.executor.extraLibrary", "file:////opt//workarea//spark_jars//commons-pool2-2.8.1.jar:file:////opt//workarea//spark_jars//postgresql-42.2.16.jar:file:////opt//workarea//spark_jars//spark-sql-kafka-0-10_2.12-3.0.1.jar:file:////opt//workarea//spark_jars//kafka-clients-2.6.0.jar:file:////opt//workarea//spark_jars//spark-streaming-kafka-0-10-assembly_2.12-3.0.1.jar") \
    ...
    event_message_detail_df_2 = event_message_detail_df_1.select(from_json(fn.col("value"), event_message_detail_schema).alias("event_message_detail"))
    ...
    event_message_detail_df_4 = event_message_detail_df_3\
        ...
        .withColumn("event_message_count", fn.lit(1))

    # Write raw data into HDFS
    #hdfs_event_message_path = "hdfs://127.0.0.1:9000/data/json/event_message_detail_raw_data"
    #hdfs_event_message_checkpoint_location_path = "hdfs://127.0.0.1:9000/data/checkpoint/event_message_detail_raw_data"
    ...
    #hdfs_event_message_path = "file:////home//ubuntu//VS Code//cloud//docker_workarea//spark_job//data//json//event_message_detail_raw_data"
    #hdfs_event_message_checkpoint_location_path = "file:////home//ubuntu//VS Code//cloud//docker_workarea//spark_job//data//checkpoint//event_message_detail_raw_data"
